...
def analyze_transcript(transcript):
    ...
    *חריגים קריטיים (זה 'כאן ועכשיו' וחובה לקודד אותם, לא NONE!):*
    ...
    אות שנייה - המוקד:
    - 'T': המטפל (כשהמטופל מדבר על תכונות המטפל עצמו, למשל "אתה יציב", "אתה לא מעריץ אותי").
    - 'P': המטופל. **כלל ברזל:** כאשר המטופל מדבר על המניעים *שלו עצמו*, הצרכים *שלו*, או הפעולות *שלו* כלפי המטפל (למשל: "אני מסכים שחלק מזה היה כדי שתעריץ", "רציתי להראות לך") - המוקד הוא תמיד P ולא T! למרות שהמטפל מוזכר, המטופל מנתח את עצמו.
